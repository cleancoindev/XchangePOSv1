...
const string strMessageMagic = "SuperMasterNode Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SuperMasterNode", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1516302719, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "RT 18JAN2018 North and South Korea talking alarming for US";
        CTransaction txNew;
        txNew.nTime = 1516302719;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1516302719;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1503873 : 1503873;
        ...
        assert(block.hashMerkleRoot == uint256("0x511b8656f25816c3800956ae1df76723e0baf053a2d68b5bbe01cfdc9d91365d"));
...
unsigned char pchMessageStart[4] = { 0x17, 0x81, 0x78, 0x0e };
